...
import com.bibitproject.aplikasidatachart.databinding.ActivityLoginStaffBinding;
...
public class LoginStaffActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_login_staff);
    ...
    private void prosesLogin(String username, String password) {
        ...
        String url = NetworkState.getUrl()+"staff/login.php";
